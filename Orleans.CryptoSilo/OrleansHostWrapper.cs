...
namespace Orleans.CryptoSilo
{
    internal class OrleansHostWrapper : IDisposable
    {
        ...
        private bool ParseArguments(string[] args)
        {
            ...
            config.Globals.SerializationProviders.Add(typeof(CryptoSerializer).GetTypeInfo());
            config.Globals.FallbackSerializationProvider = typeof(Orleans.Serialization.OrleansJsonSerializer).GetTypeInfo();
